...
>
	<svg xmlns="http://www.w3.org/2000/svg" width="18" height="10.8" viewBox="0 0 18 10.8">
		<path
			id="align-center-alt"
			d="M4.7,7.8H17.3a.9.9,0,1,0,0-1.8H4.7a.9.9,0,1,0,0,1.8Zm14.4,2.7H2.9a.9.9,0,1,0,0,1.8H19.1a.9.9,0,1,0,0-1.8ZM17.3,15H4.7a.9.9,0,0,0,0,1.8H17.3a.9.9,0,1,0,0-1.8Z"
