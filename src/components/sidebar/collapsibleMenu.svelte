...
<li class="px-2">
	...
	>
		<slot name="icon" />
		<span class="pl-2 rtl:pr-2 grow"> {text}</span>
		{#if show}
			<svg class="fill-current text-purple-700 h-6 w-6 transform transition-transform duration-500 rotate-180" viewBox="0 0 20 20">
				<path
